...
<body class="black">
	<div class="cf-container">
		...
		<div class="col-md-12 text-center">
			...
			<div class="col-md-12 text-center">
				<h2 style="font-size:2em;line-height: 0%" hidden="Scale" class="glyphicon glyphicon"><br><i style="font-size:0.3em; ">Scale <span id="bleConnIcon" class="glyphicon glyphicon-ban-circle"></span></i>
				</h2>
	...
	<div class="container" style="margin-bottom: 50px; line-height: 0%">
		<div class="row">
			<div class="col-xs-12 text-center">
				<h1 id="status" class="btn btn-warning" style="font-size:1.2em;"> Menyambung .. </h1>
			</div>
		</div>
	</div>
	<!-- //end container -->
